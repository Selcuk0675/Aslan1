...
public class LinkedList01 {
    public static void main(String[] args) {
        ...
        LinkedList<String> myList = new LinkedList<>();//bos   "null" if this list is empty
        String first = myList.peek();
        System.out.println(first);//null  PEEK
        ...
        System.out.println(firstElement);//Chris  POLL
        ...
        // Exzample 1:"A" ile baslayan tum isimleri "*****" e ceviriniz
